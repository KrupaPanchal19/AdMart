    ...
    <div id="wrapper">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <?php
                                            ...
                                            $qry="SELECT * FROM city_tble WHERE isactive =1 OR isactive =0";
        ...
        ?>
            <tr>
                ...
                <td><a href="statuschangecity.php ?id=<?php echo $row['id']?>">Change</td>
                <td><a href="editcity.php ?id=<?php echo $row['id']?>">Edit</td>
                <td><a href="deletecity.php ?id=<?php echo $row['id']?>">Delete</td>
            </tr>
            <?php 
                }
