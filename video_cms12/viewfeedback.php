 ...
 -->                             <li>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <?php
                                            ...
                                            $qry="SELECT * FROM complain_tbl WHERE isactive =1 OR isactive =0";
        ...
        <?php
            ...
            <tr>
                ...
                <td><a href="statuschangefeed.php ?com_id=<?php echo $row['com_id']?>">Change</td>
                <td><a href="editfeed.php ?com_id=<?php echo $row['com_id']?>">Edit</td>
                <td><a href="deletefeed.php ?com_id=<?php echo $row['com_id']?>">Delete</td>
            </tr>
            <?php 
                }
