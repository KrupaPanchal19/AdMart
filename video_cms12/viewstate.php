    ...
    <div id="wrapper">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <?php
                                            ...
                                            $qry="SELECT * FROM state_tbl WHERE isactive =1 OR isactive =0";
        ...
        <?php
            ...
            <tr>
                ...
                <td><a href="statuschangestate.php ?id=<?php echo $row['id']?>">Change</td>
                <td><a href="editstate.php ?id=<?php echo $row['id']?>">Edit</td>
                <td><a href="deletestate.php ?id=<?php echo $row['id']?>">Delete</td>
            </tr>
            <?php 
                }
