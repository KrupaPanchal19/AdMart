                ...
                <div class="row">
                    <div class="col-md-8 col-lg-offset-2">
                        <div class="panel panel-default">
                            ...
                            <form action="seq_insert.php" method="GET">
                        <div class="panel-body">
                              <div class="form-group">
                                <label for="exampleInputEmail1">Enter Security Question</label>
                                <input type="text" name="question" class="form-control" id="exampleInputEmail1" placeholder="Enter Security Question" />
                              </div>
