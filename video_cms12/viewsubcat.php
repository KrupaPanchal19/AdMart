    ...
    <div id="wrapper">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <?php
                                            ...
                                            $qry="SELECT * FROM subcate_tbl WHERE isactive =1 OR isactive =0";
        ...
        <?php
            ...
            <tr>
                ...
                <td><img src="<?php echo $row['img_src']?>" width="100" height="50"></td>
                <td><img src="<?php echo $row['img']?>" width="100" height="50"></td>
                <td><?php echo $row['isactive']?></td>
                <td><a href="statuschangesubcate.php ?s_id=<?php echo $row['s_id']?>">Change</td>
                <td><a href="editsubcate.php ?s_id=<?php echo $row['s_id']?>">Edit</td>
                <td><a href="deletesubcate.php ?s_id=<?php echo $row['s_id']?>">Delete</td>
            </tr>
            <?php 
                }
