       ...
       <div id="page-wrapper" class="page-wrapper-cls">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <?php
                                            ...
                                            $qry="SELECT * FROM securityque_tbl WHERE isactive =1 OR isactive =0";
        ...
        <?php
            ...
            <tr>
                ...
                <td><a href="statuschangesecque.php ?s_id=<?php echo $row['s_id']?>">Change</td>
                <td><a href="editsecque.php ?s_id=<?php echo $row['s_id']?>">Edit</td>
                <td><a href="deletesecque.php ?s_id=<?php echo $row['s_id']?>">Delete</td>
            </tr>
            <?php 
                }
