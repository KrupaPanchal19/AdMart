    ...
    <div id="wrapper">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <?php
                                            ...
                                            $qry="SELECT * FROM cont_tbl WHERE isactive =1 OR isactive =0";
        ...
        <?php
            ...
            <tr>
                ...
                <td><a href="statuschangecont.php ?c_id=<?php echo $row['c_id']?>">Change</td>
                <td><a href="editcont.php ?c_id=<?php echo $row['c_id']?>">Edit</td>
                <td><a href="deletecont.php ?c_id=<?php echo $row['c_id']?>">Delete</td>
            </tr>
            <?php 
                }
