                ...
                <div class="row">
                    <div class="col-md-8 col-lg-offset-2">
                        <div class="panel panel-default">
                            ...
                            <form action="subcateins.php" method="POST" enctype="multipart/form-data">
                        <div class="panel-body">
                              <div class="form-group">
                                <div></div>
                                 <label for="exampleInputEmail1">Enter category Name</label>
                                 <select name="cate_id" class="form-control" id="exampleInputEmail1">
                                    <?php
                            ...
                            ?>         
                                ...
                                <input type="text" name="subcate_name" class="form-control" id="exampleInputEmail1" placeholder="Enter Sub category Name" />

                                <label for="exampleInputEmail1">Enter Rate</label>
                                <input type="number" name="rate" class="form-control" id="exampleInputEmail1" placeholder="Enter Rate" />
                              </div>
                                <div class="form-group">
                                
                                    <label for="exampleInputFile"> Image_SRC</label>
