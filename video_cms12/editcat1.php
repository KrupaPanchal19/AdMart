...
<body>
    <div id="wrapper">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <?php
                                            ...
                                            $qry="SELECT * FROM cate_tble WHERE isactive =1 OR isactive =0";
        ...
        <?php
            ...
            <tr>
                ...
                <td><input type="text" name="name" value="<?php echo $row['cate_name']?>"></td>
                <td><?php echo $row['price']?></td>
                <td><?php echo $row['isactive']?></td>
                <td><a href="statuschange12.php ?cate_id=<?php echo $row['cate_id']?>">Change</td>
                <td><a href="editcat.php ?cate_id=<?php echo $row['cate_id']?>">Edit</td>
                <td><a href="delete12.php ?cate_id=<?php echo $row['cate_id']?>">Delete</td>
            </tr>
            <?php 
                } 
        }
    ...
    <footer >
        &copy; 2019 Copyright 2018 Created by<a href="http://www.designbootstrap.com/" target="_blank">Ad Mart Team</a>
    </footer>
